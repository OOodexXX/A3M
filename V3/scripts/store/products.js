...
// ✅ FIX 1: import path "./utils/formatters.js" → "../utils/formatters.js"
// ✅ FIX 2: disc → discPct (اسم الدالة الصحيح في formatters.js)
// ============================================================
...
function renderProducts(cat) {
  ...
  grid.innerHTML = list.map(p => {
    ...
    const d      = discPct(p.price, p.old); // ✅ FIX: كان disc()
